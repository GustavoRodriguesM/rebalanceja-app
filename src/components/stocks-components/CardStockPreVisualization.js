        ...
        <Card key={props.indexKey} style={getCardStyle()}>
          ...
          <Card.Content>
            {stock?.category.idCategory != 5 && (
              ...
              >
                ...
                <Paragraph style={textStyle}>
                  {"R$ " + BRLCurrencyFormat(stock?.priceInBRL)}
                </Paragraph>
              </View>
            )}
            {(stock?.category.idCategory == 3 ||
              stock?.category.idCategory == 4 ||
              stock?.category.idCategory == 6) && (
              <View
                style={{
                  flexDirection: "row",
                  alignItems: "baseline",
              ...
              >
                ...
                <Paragraph style={textStyle}>
                  {stock?.currency + " " + BRLCurrencyFormat(stock?.price)}
                </Paragraph>
              </View>
            )}
            <View
            ...
            >
              ...
              <Paragraph style={textStyle}>
                {"R$ " +
                  BRLCurrencyFormat(stock?.priceInBRL * props.selectedQuantity)}
              </Paragraph>
            </View>
            <View
              style={{
