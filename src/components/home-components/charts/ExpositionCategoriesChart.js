        ...
        return (
            <>
                <View style={{
                    ...
                    <Paragraph style={useTheme().styles.textStyle}>Cadastre uma aquisição para ter acesso total!</Paragraph>
                </View>
            </>
        )
    } else {
        return (
            <>
                <View style={{
                    ...
                    <Paragraph style={useTheme().styles.textStyle}>Sua exposição em cada classe</Paragraph>
