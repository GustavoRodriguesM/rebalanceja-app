        ...
        <>
            <View style={style.component}>
                ...
                <View style={{
                    ...
                    <Badge
                        size={10}
                        style={{ position: 'absolute', top: 6, right: 6, backgroundColor: '#fff' }}>
                    </Badge>
                    <IconButton
                        icon={"bell"}
            ...
            <Text style={[useTheme().styles.textStyle, { paddingLeft: Dimensions.get("screen").width * 0.05 }]}>Bem vindo!</Text>
        </>
    )
}
