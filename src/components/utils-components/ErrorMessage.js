  ...
  if (props.type === "existsFixedIncome" && props.error)
    return (
      ...
      >
        ...
        >
          Esse ativo já está cadastrado em outra carteira, escolha outro ticker
        </Text>
      </View>
    );
  ...
  if (props.type === "duplicateStock" && props.error)
    return (
      ...
      >
        ...
        >
          Esse ativo já existe na sua carteira!
        </Text>
      </View>
    );
  ...
  if (props.type === "minLength" && props.error) {
    return (
      ...
      >
        ...
        >
          Tamanho mínimo é {props.minLength} caracteres
        </Text>
      </View>
    );
  }
  if (props.type === "maxLength" && props.error) {
    return (
      ...
      >
        ...
        >
          Tamanho maximo é {props.maxLength} caracteres
        </Text>
      </View>
    );
  }
  if (props.type === "min" && props.error) {
    return (
      ...
      >
        ...
        >
          Campo não pode ser menor que {props.minValue}
        </Text>
      </View>
    );
  }
  if (props.type === "max" && props.error) {
    return (
      ...
      >
        ...
        >
          Campo não pode ser maior que {props.maxValue}
        </Text>
      </View>
    );
  }
