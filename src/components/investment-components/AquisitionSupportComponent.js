        ...
        <View style={style.component}>
            <Card key={props.indexKey} >
                <Card.Title
                    ...
                    titleStyle={[useTheme().styles.textStylePrimary, { fontWeight: 'bold' }]}
                ...
                <Card.Content>
                    <View
                        ...
                        <Paragraph style={useTheme().styles.textStyle}>Valor do aporte</Paragraph>
                        <Paragraph style={useTheme().styles.textStyle}>R$ {BRLCurrencyFormat(props.buyValue)}</Paragraph>
                    </View>
                    <View
                        style={{
                            flexDirection: 'row',
                        ...
                        <Paragraph style={useTheme().styles.textStyle}>Quantidade de compra</Paragraph>
                        <Paragraph style={useTheme().styles.textStyle}>{props.buyQuantity}</Paragraph>
                    </View>
                    <View
                        style={{
                            flexDirection: 'row',
                        ...
                        <Paragraph style={useTheme().styles.textStyle}>{props.percentualDifference}%</Paragraph>
                    </View>
                    <View
                        style={{
                            flexDirection: 'row',
                        ...
                        <Paragraph style={useTheme().styles.textStyle}>Valor do ativo</Paragraph>
                        <Paragraph style={useTheme().styles.textStyle}>R$ {BRLCurrencyFormat(props.priceInBRL)}</Paragraph>
                    </View>
                </Card.Content>
            </Card>
