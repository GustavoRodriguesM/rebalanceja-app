  ...
  const onSubmit = async (data) => {
    ...
    if (await new AquisitionService().createAquisition(obj)) {
      Toast.show({
        ...
        text2:
          "O ativo " +
          data.stockSymbolForm.toUpperCase() +
      ...
      Toast.show({
        ...
        text2:
          "Não foi possivel cadastrar o ativo " +
          data.stockSymbolForm.toUpperCase() +
          ". Tente novamente!",
      });
    }
    ...
    <>
      ...
      >
        <Appbar.Header style={{ alignItems: "center" }}>
          ...
          <Appbar.Content title={"Renda Variável"} subtitle={"Adicionando"} />
          <Appbar.Action
            icon="check"
                ...
                <Controller
                  ...
                  rules={{
                    ...
                    validate: {
                      ...
                      duplicateStock: async (value) => {
                        ...
                        return await new StockService().existsInActiveWallet(
                          data
                        );
                      },
                      existsStock: async (value) => {
                        let stock = await new StockService().findBySymbol(
                          value
                        );
                        return stock != null;
                      },
                  ...
                  render={({ field: { onChange, onBlur, value } }) => (
                    <TextInput
                      ...
                      onBlur={(value) => {
                        setSelectedStock(
                          control.fieldsRef.current.stockSymbolForm._f.value
                        );
                        onBlur(value);
                      }}
                      value={value}
                ...
                <Controller
                  ...
                  render={({ field: { onChange, onBlur, value } }) => (
                    <TextInput
                      ...
                      onBlur={(value) => {
                        setSelectedWeight(
                          control.fieldsRef.current.weightForm._f.value
                        );
                        onBlur(value);
                      }}
                      value={value}
                ...
                <Controller
                  ...
                  render={({ field: { onChange, onBlur, value } }) => (
                    <TextInput
                      ...
                      onBlur={(value) => {
                        setSelectedQuantity(
                          control.fieldsRef.current.quantityForm._f.value
                        );
                        onBlur(value);
                      }}
                      value={value}
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, onBlur, value } }) => (
                      <TextInput
                        ...
                        onChangeText={(value) =>
                          onChange(convertCurrency(value))
                        }
                        style={{
                          backgroundColor: "#262626",
                        }}
