  ...
  success: ({ text1, text2, ...rest }) => (
    <BaseToast
      ...
      contentContainerStyle={{
        backgroundColor: RebalanceJaTheme.colors.modalBackground,
    ...
    return (
      <PaperProvider theme={RebalanceJaTheme}>
        <InternetConnectionAlert
          title={"Opa!"}
          message={
            "Parece que você está sem internet. O app pode apresentar problemas."
          }
          ...
          >
            <NavigationContainer>
              ...
              >
                ...
                <Stack.Screen
                  name="InitialParamsScreen"
                  component={InitialParamsScreen}
                />
              </Stack.Navigator>
            </NavigationContainer>
          </SafeAreaView>
